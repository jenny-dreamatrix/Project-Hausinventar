...
const DetailMidStuff = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const { data } = await axios.get(`/api/notsobigstuff/${params.id}`)
            setDetailData(data)
        }
        fetchData()
    },[refresh])
    ...
    const EditTitle = async (e) => {
        ...
        const {data} = await axios.put(`/api/notsobigstuff/${params.id}`, newTitle)
    ...
    const EditRoom = async (e) => {
        ...
        const {data} = await axios.put(`/api/notsobigstuff/${params.id}`, newRoom)
        setRefresh(prev => !prev)
    ...
    const EditContent = async (e) => {
        ...
        const {data} = await axios.put(`/api/notsobigstuff/${params.id}`, newContent)
        setRefresh(prev => !prev)
    ...
    //     const {data} = await axios.put(`/api/notsobigstuff/${params.id}`, formData)
    //     setRefresh(prev => !prev)
